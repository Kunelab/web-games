...
export const atelierEn: Catalogue = {
  ...
  "lib.import.doneUnfinished":
    "{count} media imported, {unfinished} of them to finish.",
  ...
  "ple.readOnlyHint":
    "Shared publicly by {owner}. Duplicate it to make it yours and edit freely.",
  ...
  "field.youtubeHelp":
    "Paste a link and the title and artist are filled in for you.",
  ...
  "field.grid": "Grid",
  "field.gridHelp":
    "Build a grid by theme, or leave it empty and give one image below.",
  ...
  "miss.question": "the question",
  "miss.image": "the image",
  "miss.panel": "the grid, or a single panel image",
  "miss.answer": "at least one answer",
  "miss.choiceMissing": "a right answer that appears among its own choices",
  "miss.unknownKind": "a media type this version understands",
  "me.back": "← Library",
  "me.new": "New media",
  ...
  "me.answersHint":
    "One answer per thing to find. The player names whatever they like and the server works out which one they meant.",
  "me.filing": "Filing",
  ...
  "me.timing": "Timing",
  "me.defaults": "By default: {answer} s to answer, {reveal} s of reveal.",
  "me.customise": "Customise for this media",
  "me.backToDefault": "Back to the default",
  "me.seconds": "seconds",
  "me.ready": "ready",
  "me.playable": "Playable in a game.",
  "me.draft": "draft",
  "me.missing": "Missing {fields}.",
  "me.cancel": "Back",
  "me.save": "Save",
  "me.saveFailed": "Could not save.",
  "me.test": "Test",
  "me.testHint": "Saves, then plays this media on its own, as in a game.",
  "me.testFailed": "Could not start the test.",
  "me.answerTime": "Answering time",
  "me.revealTime": "Reveal length",
  "ans.label": "Prompt",
  "ans.labelHint":
    "Optional. Left empty, the player is asked nothing: they name what they see.",
  "ans.labelEg": "Title, Artist, Year…",
  "ans.points": "Points",
  "ans.strictness": "Strictness",
  "ans.none":
    "No answers: this media cannot be played until it has at least one.",
  "ans.add": "Add an answer",
  "ans.total": "Round total: {points} points",
  "ans.aliasesEg": "Die Aerzte, Aerzte",
  "ans.choiceN": "Choice {n}",
  "ans.removeChoice": "Remove choice {n}",
  "ans.addChoice": "Add a choice",
  ...
  "ans.numbersStrict":
    "Numbers must be exact. The rest tolerates case, accents and one mistake.",
  "ans.normal":
    "Case, accents and punctuation ignored. One mistake per longish word, swapped letters and phonetic spelling are all tolerated.",
  "ans.correct": "Correct answer",
  "ans.aliases": "Other accepted wordings",
  "ans.aliasesHint":
    "Comma separated. For genuinely different names, not for typos.",
  "ans.offerChoices": "Offer choices",
  "ans.offerChoicesHint":
    "A player can answer blind for more points, or reveal the choices for fewer.",
  "ans.choices": "The choices offered",
  "ans.choicesHint":
    "The correct answer must appear in the list, spelled identically.",
  "ans.directBonus": "Blind-answer bonus",
  "ans.directBonusHint":
    "Extra points when the player does not reveal the choices.",
  "pl.live": "Game in progress:",
  "pl.liveWaiting": " (waiting for players)",
  "pl.liveOver": " (finished)",
  "pl.liveEmpty": " (nobody left in it)",
  "pl.livePlayers": " ({connected}/{players} connected)",
  "pl.resume": "Resume",
  "pl.reopen": "Reopen",
  "pl.end": "End",
  "pl.endSure": "End it?",
  "pl.ended": "Game {code} ended.",
  "pl.endFailed": "Could not end that game.",
  "pl.none": "No playlist",
  "pl.createFirst": "Create the first one",
  "pl.whatIsPlaylist":
    "A playlist gathers media in the order they will be played.",
  ...
  "hist.noneNote":
    "Finished games will appear here, with their podium and their honours.",
  ...
  "ple.nothingLeft":
    "Everything is already in the playlist, or nothing matched.",
  ...
  "launch.stage.tv.hint":
    "One screen plays the media; the phones get the prompts and the answer boxes. You choose which screen in the lobby.",
  ...
  "launch.combo.hint":
    "Winning several rounds in a row multiplies the points: ×1.1, ×1.2… up to ×2.",
  ...
  "launch.howOral.3":
    "A phone can still join with the code if you want to test the player screen.",
