...
export const screenEn: Catalogue = {
  ...
  'mafia.bot.roleClaim.5': 'I am the {role}. Somebody else stand up.',
  ...
  'mafia.bot.why.buddy.1': 'they and {who} have never once voted for each other',
  'mafia.bot.why.buddy.2': '{who} and them vote together and never against',
  'mafia.bot.why.buddy.3': 'their name and {who}’s have never crossed on a ballot',
