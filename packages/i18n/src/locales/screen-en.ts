...
export const screenEn: Catalogue = {
  ...
  'mafia.bot.roleClaim.2': '{role} here.',
  'mafia.bot.roleClaim.3': 'I am the {role}. Use it.',
  'mafia.bot.roleClaim.4': 'I am the {role}. Check me tomorrow.',
  'mafia.bot.roleClaim.5': '{role}. Somebody else stand up.',
  'mafia.bot.roleClaim.6': 'Fine. {role}.',
  /**
  ...
  'mafia.bot.visited.3': '{who}, last night.',
  'mafia.bot.visited.4': 'My night was {who}.',
  'mafia.bot.visited.5': 'I called on {who}.',
  'mafia.bot.visited.6': '{who}. That is where I was.',
  'mafia.bot.visited.7': 'Out at {who}, nowhere else.',
  'mafia.bot.visited.8': 'I visited {who}. Check it.',
  'mafia.bot.visited.9': '{who} last night, that is all.',
  ...
  'mafia.bot.question.7': '{who}, night, please.',
  ...
  'mafia.bot.sighting.9': 'Whoever was at {who}, say so.',
  /**
  ...
  'mafia.bot.taunt.2': 'Not much from {who}.',
  'mafia.bot.taunt.3': '{who}, still there?',
  'mafia.bot.taunt.4': '{who}, who are you voting?',
  'mafia.bot.taunt.5': 'Anyone heard {who} today?',
  ...
  'mafia.bot.why.contradiction.1': 'they said home and {who} saw them out',
  'mafia.bot.why.contradiction.2': 'they claim home, {who} says otherwise',
  'mafia.bot.why.contradiction.3': '{who} puts them outside on a night they slept through',
  'mafia.bot.why.seen.1': '{who} had them out on night {night}',
  'mafia.bot.why.seen.2': 'night {night}, {who} saw them leave',
  'mafia.bot.why.seen.3': '{who} puts them on a doorstep, night {night}',
  'mafia.bot.why.check.1': 'I checked them night {night} and it came back bad',
  'mafia.bot.why.check.2': 'night {night} I checked them: bad',
  'mafia.bot.why.check.3': 'my night {night} check on them was not clean',
  'mafia.bot.why.checkNamed.1': 'I checked them night {night}: {what}',
  'mafia.bot.why.checkNamed.2': 'night {night} my check came back {what}',
  'mafia.bot.why.checkNamed.3': 'my night {night} check put them as {what}',
  'mafia.bot.why.admitted.1': 'they said they were at {who} on night {night}',
  'mafia.bot.why.admitted.2': 'their own account puts them at {who}, night {night}',
  'mafia.bot.why.admitted.3': 'night {night} at {who}, their words',
  'mafia.bot.why.doubleClaim.1': 'they and {who} both claim {role}',
  'mafia.bot.why.doubleClaim.2': 'two {role}s: them and {who}',
  'mafia.bot.why.doubleClaim.3': 'the {role} badge is on them and on {who}',
  'mafia.bot.why.myBadge.1': 'I am the {role}, so they are lying',
  'mafia.bot.why.myBadge.2': 'they took my badge, I am the {role}',
  'mafia.bot.why.myBadge.3': 'I am the {role} and they cannot be',
  'mafia.bot.why.silent.1': 'they have said nothing all game',
  'mafia.bot.why.silent.2': 'not one claim from them all game',
  'mafia.bot.why.silent.3': 'a whole game of silence is a choice',
  'mafia.bot.why.wagon.1': 'the votes are on them and no answer',
  'mafia.bot.why.wagon.2': 'the room is voting them and they say nothing',
  'mafia.bot.why.wagon.3': 'they have answered none of those votes',
  'mafia.bot.why.nowhere.1': 'nobody has placed them on any night',
  'mafia.bot.why.nowhere.2': 'they have never said where they were',
  'mafia.bot.why.nowhere.3': 'none of their nights are on the record',
  'mafia.bot.why.accused.1': '{who} called them out and it went unanswered',
  'mafia.bot.why.accused.2': '{who} named them and they have not answered',
  'mafia.bot.why.accused.3': '{who} put a name on them and nothing came back',
  'mafia.bot.why.badge.1': '{who} claims {role} and has them',
  'mafia.bot.why.badge.2': 'the {role} is {who}, and {who} named them',
  'mafia.bot.why.badge.3': '{who} claimed {role} and put them top of the list',
  /**
  ...
  'mafia.bot.why.trade.2': 'night {night} I examined them, and {line}',
  'mafia.bot.why.trade.3': 'my night {night} examine came back: {line}',

  /* ------------------------- and why one is worth keeping ------------------- */
  'mafia.bot.whyClear.mine.1': 'I checked them night {night} and they came back clean',
  'mafia.bot.whyClear.mine.2': 'night {night} I looked into them: nothing',
  'mafia.bot.whyClear.mine.3': 'my night {night} check on them was clean',
  'mafia.bot.whyClear.vouched.1': '{who}, who claims {role}, has already cleared them',
  'mafia.bot.whyClear.vouched.2': 'the {role} is {who}, and they have them clean',
  'mafia.bot.whyClear.vouched.3': '{who} claimed {role} and took them off the list',
  'mafia.bot.whyClear.accounted.1': 'they gave their night and nobody contradicted it',
  'mafia.bot.whyClear.accounted.2': 'their account is on the record and it holds',
  'mafia.bot.whyClear.accounted.3': 'nobody has caught them out on a night',
  'mafia.bot.whyClear.trade.1': 'I examined them on night {night}: {line}, which is town here',
  'mafia.bot.whyClear.trade.2': 'night {night} I examined them, and {line}',
  ...
  'mafia.bot.stake.role.4': '{who} is the {role}. If not, I am your next rope.',
  'mafia.bot.stake.role.5': 'Put me up tomorrow if {who} is not the {role}.',
  'mafia.bot.stake.role.6': '{who} is the {role}, and my neck says so.',
  ...
  'mafia.bot.stake.faction.4': '{who} is {faction}. If not, I am your next rope.',
  'mafia.bot.stake.faction.5': 'Put me up tomorrow if {who} is not {faction}.',
  'mafia.bot.stake.faction.6': '{who} is {faction}, and my neck says so.',
  ...
  'mafia.bot.denyWhy.alone.3': 'it is one voice and no second one',

  /* ------------------------------- on the stand ----------------------------- */
  'mafia.bot.defend.accuser.1': '{who} started this, and {who} has been caught out already.',
  ...
  'mafia.bot.defend.role.2': 'I am the {role}. Kill me and the town loses it.',
  'mafia.bot.defend.role.3': '{role}. That is my defence.',
  'mafia.bot.defend.visited.1': 'I was at {who} last night, and I said so before this started.',
  'mafia.bot.defend.visited.2': '{who}, last night. I said that before the wagon.',
  'mafia.bot.defend.visited.3': 'I told you where I was: {who}. Check it.',
  ...
  'mafia.bot.defend.nothing.3': 'Somebody say what for.',
  /**
  ...
  'mafia.bot.healed.3': 'Healed last night. So there is a doctor alive.',
  ...
  'mafia.bot.guarded.5': 'A bodyguard went down at my door. Count that.',
  ...
  'mafia.bot.survived.2': 'They tried me last night. It did not take.',
  ...
  'mafia.bot.silenced.3': 'I got the letter. I was mute all of yesterday.',
  'mafia.bot.silenced.4': 'Blackmailed yesterday. So there is a blackmailer alive.',
  ...
  'mafia.bot.blocked.4': 'I was blocked last night, so there is an escort type alive.',
  'mafia.bot.blocked.5': 'No result from me: I was roleblocked.',
  'mafia.bot.blocked.6': 'Somebody sat on me last night. Nothing to report.',
  ...
  'mafia.bot.controlled.3': 'Witched last night. So there is a witch alive.',
  ...
  'mafia.bot.bussed.4': 'I was swapped last night, so there is a bus driver alive.',
  ...
  'mafia.bot.family.why.pushing.3': '{who} is theirs by tomorrow',
  ...
  'mafia.bot.dump.nobody.2': 'Night {night}, {who}: no callers.',
  ...
  'mafia.bot.dump.closing.1': 'That is everything. Hang me and it dies with me.',
  ...
  'mafia.bot.crier.suspect.3': 'Somebody unseen says {who}.',
  ...
  'mafia.bot.fact.hangedTown.2': '{who} was the {role}. That rope was wrong.',
  'mafia.bot.fact.hangedTown.3': 'Yesterday’s hanging was a mistake: {who}, {role}.',
  'mafia.bot.fact.hangedEvil.1': '{who} was the {role}. Good rope.',
  ...
  'mafia.bot.fact.votersWrong.3': 'Guilty on {who}: {names}. {who} was town.',
  ...
  'mafia.bot.jail.ask.4': 'I can kill you from here. Talk.',
  ...
  'mafia.bot.jail.ask.9': 'I have one execution. Talk me out of it.',
