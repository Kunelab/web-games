...
export const screenEn: Catalogue = {
  ...
  */
  ...
  'mafia.bot.family.refuse.pris.1': 'Not {who} tonight, one of us is already on them.',
  'mafia.bot.family.refuse.pris.2': '{who} is out of reach tonight: already taken care of.',
  'mafia.bot.family.refuse.pris.3': 'We cannot touch {who} tonight, one of ours is already holding them.',
  'mafia.bot.family.refuse.blinde.1': 'Not {who}, our knife already bounced off that door.',
  'mafia.bot.family.refuse.blinde.2': 'We tried {who} before and the blade did not get through. We would waste the night.',
  'mafia.bot.family.refuse.blinde.3': '{who} is armoured, we learned that the hard way. Somewhere else.',
  'mafia.bot.family.refuse.veteran.1': 'Not {who}, that is the Veteran. Whoever walks in dies.',
  'mafia.bot.family.refuse.veteran.2': '{who} sits on the porch with a rifle. We are not going there.',
  'mafia.bot.family.refuse.veteran.3': 'The house of {who}? The Veteran is waiting. No.',
  'mafia.bot.family.refuse.ami.1': 'Not {who}, they are doing our work in the square.',
  'mafia.bot.family.refuse.ami.2': '{who} is worth more to us alive: they stood up for one of ours.',
  'mafia.bot.family.refuse.ami.3': 'Leave {who}, they vote with us. Worth more alive.',
  'mafia.bot.family.refuse.rate.1': 'We missed {who} last night, somebody is protecting them. Somewhere else tonight.',
  'mafia.bot.family.refuse.rate.2': '{who} survived our visit, they are guarded. Let us switch.',
  'mafia.bot.family.refuse.rate.3': 'Not {who}, we were there last night and they are still breathing.',
  'mafia.bot.family.refuse.pendu.1': 'Not {who}, the town is hanging them tomorrow anyway.',
  'mafia.bot.family.refuse.pendu.2': '{who} is already on the rope. Do not waste the knife.',
  'mafia.bot.family.refuse.pendu.3': 'The square takes care of {who} tomorrow. Someone else tonight.',
  'mafia.bot.family.refuse.desavoue.1': 'Not {who}. Your last tips cost us.',
  'mafia.bot.family.refuse.desavoue.2': 'I am not following you on names like that any more. Not {who}.',
  'mafia.bot.family.refuse.desavoue.3': '{who}? Last time I listened to you, we paid for it.',
