...
export const siteFr: Catalogue = {
  ...
  "site.game.mafia.tagline":
    "Une ville, des tueurs, et personne qui dit la vérité.",
  ...
  "site.menu.mafia.lede":
    "Une ville, des tueurs cachés parmi elle, et personne qui dit toute la vérité. Cinq à quinze joueurs, chacun sur son téléphone, une télé en option.",

  /* -------------------------------- les tuiles ------------------------------ */
  "site.tile.quick": "Partie rapide",
  "site.tile.quick.quiz":
    "Un quiz tiré au sort, des inconnus, aucun organisateur.",
  "site.tile.quick.coronaz":
    "Un quartier tiré au sort, une équipe formée sur place.",
  "site.tile.quick.mafia":
    "Une table qui se remplit toute seule, complétée par des bots au besoin.",

  "site.tile.endless": "Blind test infini",
  "site.tile.endless.hint":
  ...
  "site.tile.createTable.hint":
    "Distribution des rôles, durée du jour, ce qu’un cadavre révèle.",
  ...
  "site.tile.joinTable.hint":
    "Un code, ou la liste des tables publiques ouvertes.",

  "site.tile.newQuestion": "Créer une question",
  "site.tile.newQuestion.hint":
    "Blind test, question, estimation, image à révéler, panel à mémoriser.",
  "site.tile.newQuiz": "Créer un quiz",
  "site.tile.newQuiz.hint":
    "Un groupe de questions, jouable en une soirée. Publiable.",
  ...
  "site.tile.history.quiz":
    "Les parties terminées et ce qu’elles ont laissé, tous jeux confondus.",
  "site.tile.history.coronaz":
    "Les raids terminés, les records par scénario et les trophées.",
  "site.tile.history.mafia":
    "Les parties terminées, et ce que chacun a fini par devenir.",
  ...
  "site.tile.locker.quiz":
    "Choisir ce que vous portez sur le tableau des scores.",
  ...
  "site.tile.guide.quiz.hint":
    "Comment se calcule le score, et ce que chaque type demande.",
  "site.tile.guide.coronaz": "Lore, bestiaire et règles",
  "site.tile.guide.coronaz.hint":
    "Ce qui est arrivé au quartier, ce qui y vit, et comment on en sort.",
  ...
  "site.notFound.lede":
    "Ce lien ne mène à rien. Le menu en haut ramène en terrain connu.",
};
