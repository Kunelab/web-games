...
export const siteEn: Catalogue = {
  ...
  "site.menu.mafia.lede":
    "One town, killers hidden inside it, and nobody telling the whole truth. Five to fifteen players, each on their own phone, a TV optional.",

  /* -------------------------------- the tiles ------------------------------- */
  "site.tile.quick": "Quick match",
  "site.tile.quick.quiz": "A quiz drawn at random, strangers, no organiser.",
  "site.tile.quick.coronaz":
    "A neighbourhood drawn at random, a team formed on the spot.",
  "site.tile.quick.mafia":
    "A table that fills itself, topped up with bots as needed.",

  "site.tile.endless": "Endless blind test",
  ...
  "site.tile.createTable.hint":
    "How the roles are dealt, how long a day lasts, what a body gives away.",
  ...
  "site.tile.newQuestion.hint":
    "Blind test, question, estimate, picture to reveal, panel to memorise.",
  "site.tile.newQuiz": "Build a quiz",
  "site.tile.newQuiz.hint":
    "A group of questions, playable in one evening. Publishable.",
  "site.tile.library": "My library",
  "site.tile.library.hint":
    "Find and edit the questions you have already written.",

  "site.tile.history": "History and careers",
  "site.tile.history.quiz":
    "Finished games and what they left behind, across every game.",
  "site.tile.history.coronaz":
    "Finished raids, the per-scenario records and the trophies.",
  "site.tile.history.mafia":
    "Finished games, and what everybody turned out to be.",
  ...
  "site.tile.guide.quiz.hint":
    "How the score is worked out, and what each type asks of you.",
  "site.tile.guide.coronaz": "Lore, bestiary and rules",
  "site.tile.guide.coronaz.hint":
    "What happened to the neighbourhood, what lives there, and how anyone gets out.",
  ...
  "site.notFound.lede":
    "This link leads nowhere. The menu at the top gets you back to familiar ground.",
};
