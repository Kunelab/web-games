...
export const playFr: Catalogue = {
  ...
  "host.tvPick": "Quel écran est la télévision ?",
  "host.tvThisScreen": "Cet écran",
  "host.tvHint":
    "Le média ne passe que là. Tous les autres reçoivent les intitulés et leur champ de réponse.",
  "host.soloSeat":
    "Vous jouez sur cet écran : la scène au-dessus, vos réponses en dessous.",
  "host.joinWithCode": "Rejoindre avec ce code",
  "host.remove": "Retirer {name}",
  "host.answersToFind": "{count} réponses à trouver",
  "play.soundBlocked":
    "Ce navigateur ne lancera pas le son tout seul. Un appui suffit.",
