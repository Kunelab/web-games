...
export const playFr: Catalogue = {
  ...
  "play.buzz.yours": "Vous avez le buzzer. Répondez !",
  "play.buzz.taken": "{name} a le buzzer",
  "play.buzz.racing": "Buzz enregistré. On départage…",
  "play.buzz.spent": "Vous avez déjà tenté ce tour.",
  "play.gotIt": "trouvé",
  ...
  "badge.unit.games": "parties",
  "badge.unit.wins": "victoires",
  "badge.unit.correct": "bonnes réponses",
  "badge.unit.awards": "distinctions",
  "badge.unit.streak": "d'affilée",
  "badge.unit.ms": "ms",

  "mafia.unit.tables": "parties",
  "mafia.unit.wins": "victoires",
  "mafia.unit.soloWins": "en solo",
  "mafia.unit.kills": "victimes",
  "mafia.unit.survived": "survies",

  "mafia.badge.first-table": "Nouveau",
  "mafia.badge.first-table.hint": "A rejoint sa première table",
  "mafia.badge.first-blood": "Premier sang",
  "mafia.badge.first-blood.hint": "A gagné une fois",
  "mafia.badge.regular": "Habitué",
  "mafia.badge.regular.hint": "10 parties",
  "mafia.badge.survivor": "Survivant",
  "mafia.badge.survivor.hint": "En est ressorti vivant 10 fois",
  "mafia.badge.lone-wolf": "Loup solitaire",
  "mafia.badge.lone-wolf.hint": "A gagné seul une partie",
  "mafia.badge.blooded": "Aguerri",
  "mafia.badge.blooded.hint": "10 victimes",
  "mafia.badge.veteran": "Vétéran",
  "mafia.badge.veteran.hint": "50 parties",
  "mafia.badge.executioner": "Bourreau",
  "mafia.badge.executioner.hint": "25 victimes",
  "mafia.badge.kingmaker": "Faiseur de rois",
  "mafia.badge.kingmaker.hint": "25 victoires",
  "mafia.badge.legend": "Légende",
  "mafia.badge.legend.hint": "50 victoires",

  "play.rewards.career": "Votre carrière",
  "play.rewards.inStock": "{count} au total",
  "play.rewards.newTitle": "Nouveau titre",
  "play.rewards.next": "Bientôt",
};
