...
export const notesFr: Catalogue = {
  ...
  'mafia.note.convertCrowded': 'Un autre d’entre nous a ouvert une porte avant toi cette nuit ; {name} est resté où il était.',
  ...
  'mafia.note.blockDone': 'Vous avez occupé {name} toute la nuit. Quoi qu’il ait prévu, ça n’a pas eu lieu.',
  'mafia.note.blockFailed': '{name} veillait, armé, sur son perron. Personne n’occupe celui-là.',
  ...
  'mafia.note.attackImmune': 'Votre lame a trouvé plus dur que la peau. Cette maison ne tombe pas comme ça.',
  'mafia.note.attackVested': 'Du rembourrage, sous la chemise. Quelqu’un vous attendait.',
  'mafia.note.attackHealed': 'Vous l’avez laissé pour mort, et on l’a recousu avant l’aube.',
  'mafia.note.attackTooLate': 'Quelqu’un était déjà passé. Vous avez planté votre lame dans un cadavre.',
  'mafia.note.powerSpent': 'Vous n’avez plus rien à dépenser cette nuit.',
